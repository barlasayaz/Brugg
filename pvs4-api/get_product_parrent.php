...
function processing($parentId) {
    ...
    $parentId   = trim( mysqli_escape_string($con,$parentId) );
    
    $sql    = "SELECT * FROM `products` WHERE `parent`=$parentId and `active` = 1;";
