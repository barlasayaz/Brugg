...
function processing() {
    ...
    // ---------------------------------------------------------------------------------------------- //  
    function upload_file($encoded_string, $export_date){
        ...
        $file = 'Statistik_' . $export_date . '.' . $extension; // rename file as a unique name
        $file_dir = $target_dir . 'Statistik_' . $export_date. '.' . $extension;
        try {
    ...
    $fileattach = upload_file($encoded_string, $export_date);
