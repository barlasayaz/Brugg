...
function processing() {
    ...
    $system_role  = trim( mysqli_escape_string($con,$_POST['system_role']) );
    $licensee_role= trim( mysqli_escape_string($con,$_POST['licensee_role']) );
    $customer_role= trim( mysqli_escape_string($con,$_POST['customer_role']) );
