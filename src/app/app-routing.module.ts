...
const routes: Routes = [
  ...
  { path: 'product-edit/:id', loadChildren: './product-edit/product-edit.module#ProductEditPageModule' },
  ...
  { path: 'protocol-edit/:id', loadChildren: './protocol-edit/protocol-edit.module#ProtocolEditPageModule' },
  ...
  { path: 'appointment-edit/:id', loadChildren: './components/appointment-edit/appointment-edit.module#AppointmentEditComponentModule' },
  { path: 'customer-edit/:id', loadChildren: './components/customer-edit/customer-edit.module#CustomerEditComponentModule' },
  ...
  { path: 'note-edit/:id', loadChildren: './components/note-edit/note-edit.module#NoteEditComponentModule' },
