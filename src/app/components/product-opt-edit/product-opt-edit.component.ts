...
/* import { ProductTemplatePage } from '../../pages/product-template/product-template';  --DP-- */

@Component({
  selector: 'app-product-opt-edit',
  templateUrl: './product-opt-edit.component.html',
  styleUrls: ['./product-opt-edit.component.scss']
})
export class ProductOptEditComponent {
  ...
  constructor(public navCtrl: NavController,
    ...
    public alertCtrl: AlertController) {
      ...
      if (this.idOption > 0) {  // Edit
        ...
        //this.activOption.options = JSON.parse(this.activOption.options);
      ...
      console.log("ProductOptEditComponent: ", this.idOption);
  
    }
  
    loadOption() {
      this.apiService.pvs4_get_product_opt(1, 1).then((result: any) => {
